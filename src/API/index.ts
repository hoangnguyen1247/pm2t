...
import APIDeploy from './Deploy';
import APIModule from './Modules/index';

import APIPlusLink from './pm2-plus/link';
import APIPlusProcess from './pm2-plus/process-selector';
import APIPlusHelper from './pm2-plus/helpers';

import APIConfig from './Configuration';
import APIVersion from './Version';
import APIStartup from './Startup';
import APIMgnt from './LogManagement';
import APIContainer from './Containerizer';
 ...
 * @param {Function} cb Callback
 */
API.prototype.killDaemon = function (cb) {
...
API.prototype.kill = function (cb) {
    this.killDaemon(cb);
}
 ...
 * @return
 */
API.prototype.slist = function (tree) {
 ...
 * @return
 */
API.prototype.speedList = function (code?, apps_acted?) {
    var systemdata = null
    var acted = []
