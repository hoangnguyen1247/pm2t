...
const Log = {
    ...
    tail: function(apps_list, lines, raw, callback) {
        ...
        forEachLimit(apps_list, 1, (app, next) => {
    ...
    stream: (Client, id, raw, timestamp?, exclusive?, highlight?) => {
    ...
    devStream: function(Client, id, raw, timestamp, exclusive) {
    ...
    formatStream: function(Client, id, raw, timestamp, exclusive?, highlight?) {
        Client.launchBus(function(err, bus) {
