...
const debug = debugLogger("pm2:conf");

/**
 * Get PM2 path structure
 */
const path_structure = paths(process.env.OVER_HOME);
...
const csts: any = {
    ...
    PM2_BANNER: "../motd",
    PM2_UPDATE: "../API/pm2-plus/pres/motd.update",
...
Object.assign(csts, path_structure);
